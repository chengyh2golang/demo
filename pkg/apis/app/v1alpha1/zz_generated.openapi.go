...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"demo/pkg/apis/app/v1alpha1.Demo":       schema_pkg_apis_app_v1alpha1_Demo(ref),
		"demo/pkg/apis/app/v1alpha1.DemoSpec":   schema_pkg_apis_app_v1alpha1_DemoSpec(ref),
		"demo/pkg/apis/app/v1alpha1.DemoStatus": schema_pkg_apis_app_v1alpha1_DemoStatus(ref),
	}
}
...
func schema_pkg_apis_app_v1alpha1_Demo(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("demo/pkg/apis/app/v1alpha1.DemoSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("demo/pkg/apis/app/v1alpha1.DemoStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"demo/pkg/apis/app/v1alpha1.DemoSpec", "demo/pkg/apis/app/v1alpha1.DemoStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
